...
from utils.model.build_model import build_model_llava_more
...
def main():
    ...
    model_name = "llava"
    tokenizer, model, image_processor, content_length = build_model_llava_more(
        args.lm_reward_model_name_or_path,
        model_name
    )
    ...
    for epoch in range(start_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(tqdm(train_dataloader)):
            ...
            images = torch.stack(batch["image"]).to(model.dtype)
